...
export default class Signal {
    ...
    * automatically kill listener during `add()`/`addOnce()` if Signal was
    ...
    */
    ...
    constructor(typeOne:any = null, typeTwo:any = null) {
    ...
    */
    public dispatch(...paramsArr: any[]) {
        ...
        //kill all callbacks until end of the list or until a callback returns `false` or stops propagation
